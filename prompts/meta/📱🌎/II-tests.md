...
## this round's focus
look through the github test workflows
speed up the slowest tests
remove not useful ones (less sometimes is more)
all in all smoothen test workflows so they are in average faster than builds
